...
export const FINTECH_CONFIG_DEFAULTS = Object.freeze({
  ...
  ambassador_guest_pool_l3_percent: 0,
  ...
  // L3 knobs (ADR-131A). Flag stays false in A1.1 — no live L3 / no 42/10/5 cutover.
  // Atomic cutover in A1.2: 42/10/5/43 + l3_enabled + program cap 1_000_000.
