...
export const FINTECH_CONFIG_DEFAULTS = Object.freeze({
  ...
  // Owner waterfall (%)
  /**
   * Stage 202.25 — Insurance fund % (was hardcoded 0.005 in waterfall preview).
   * % of platform gross margin (guest fee + host commission THB).
   */
  ...
  // Supply Builder (host activation) — Stage 202.40: 100% L1, pot 760 THB (~₽2500 RF mid)
...
/** Stage 202.25 — insurance fund default (alias for docs/tests). */
export const INSURANCE_FUND_PERCENT_DEFAULT = FINTECH_CONFIG_DEFAULTS.insurance_fund_percent

/** CamelCase mirrors for JS `??` fallbacks (same numbers as snake keys above). */
export const FINTECH_JS_DEFAULTS = Object.freeze({
  insuranceFundPercent: FINTECH_CONFIG_DEFAULTS.insurance_fund_percent,
