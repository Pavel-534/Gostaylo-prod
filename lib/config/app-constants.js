 ...
 *
 * Crypto wallet SSOT (Stage 200.75): import from `@/lib/config/crypto-receive-wallet.js`
 * only on crypto/checkout paths — do not re-export here (avoids fail-closing catalog/booking).
 */
