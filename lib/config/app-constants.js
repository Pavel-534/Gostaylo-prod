...
/**
 * Platform USDT (TRC-20) receive address for crypto checkout.
 * Prefer env; legacy hardcoded fallback only if unset (AUDIT_01 WARN).
 */
export const GOSTAYLO_WALLET = String(
  process.env.NEXT_PUBLIC_CRYPTO_RECEIVE_WALLET ||
    process.env.CRYPTO_RECEIVE_WALLET ||
    'TXyfMKVxUNFkC8Q77GnbAqgnWFUWVaKwZ5',
).trim()
