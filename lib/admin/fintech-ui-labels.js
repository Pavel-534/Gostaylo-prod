...
export const BREAKDOWN_ROWS = [
  { key: 'subtotal_thb', label: 'Чистая стоимость хоста (Базовые баты)' },
  { key: 'guest_service_fee_thb', label: 'Сервисный сбор с гостя (Маржа платформы)' },
  { key: 'ru_fee_thb', label: 'Доля Агента в РФ (Доход ИП)' },
  { key: 'kr_fee_thb', label: 'Доля Сервиса в КР (Доход ОсОО — ИТ-услуги)' },
  { key: 'fx_markup_thb', label: 'Курсовой спред (Доход от конвертации)' },
  { key: 'total_partner_netto_thb', label: 'К выплате партнеру в Таиланд' },
  { key: 'total_guest_payable_thb', label: 'Точный итог для гостя (до округления)' },
...
export const POOL_MESSAGES_RU = {
  no_ready_bookings: 'Нет завершенных бронирований, готовых к выплате хостам',
