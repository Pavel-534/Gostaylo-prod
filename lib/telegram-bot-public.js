 ...
 *
 * На проде TELEGRAM_BOT_TOKEN должен быть выдан BotFather именно для этого @username,
 * иначе вебхук будет отвечать от другого бота, а ссылки с сайта — открывать FunnyRent_777_bot.
 */

/** Fallback, если в билде не задан NEXT_PUBLIC_TELEGRAM_BOT_USERNAME — должен совпадать с @username в BotFather */
