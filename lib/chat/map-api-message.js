...
import { maskContactInfo, isBookingPaid } from '@/lib/mask-contacts'
...
export function mapApiMessageToRow(raw, opts = {}) {
  ...
  const isRead = pick(raw, 'isRead', 'is_read', false)
  ...
  //   b) booking ещё не на «безопасном» статусе (isBookingPaid = false)
