 ...
 * No `/renter/*` — middleware login redirects poison App Router prefetch (Stage 202.50 / 201.56). */
...
/** Avatar menu destinations (Stage 200.16).
 * No `/partner/*` or `/renter/*` — middleware login redirects poison App Router prefetch
 * (Stage 201.56 partner; Stage 202.50 renter profile / favorites). */
