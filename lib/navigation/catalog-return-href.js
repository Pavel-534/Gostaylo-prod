...
import { clearCatalogMapViewport } from './catalog-map-viewport-memory.js'
import { readCatalogMobileMapOpenFromLocation } from './catalog-mobile-map-hash.js'
 ...
 * If mobile map is not open, drop any stale map camera snapshot.
 */
