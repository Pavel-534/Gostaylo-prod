/**
 * KYC files live in private bucket `verification_documents` (Stage 154.1).
 * Do not link `/_storage/verification_documents/…` — bucket is not public.
 * Admin UI: `/api/v2/admin/verification-doc?path=…` (staff + 15m signed URL).
 * Partner owner: `/api/v2/partner/verification-doc?path=…`.
 */
