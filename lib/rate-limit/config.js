...
export const RATE_LIMITS = {
  ...
  referral_leaderboard_public: { windowMs: 60 * 1000, max: 60 },
  ...
  /** Stage 189.2 — SMS OTP: 1 send / 60s per phone (extraIdentity) */
  sms_otp: { windowMs: 60 * 1000, max: 1 },
  /** Stage 189.2 — SMS OTP: burst guard per IP */
  sms_otp_ip: { windowMs: 60 * 1000, max: 8 },
