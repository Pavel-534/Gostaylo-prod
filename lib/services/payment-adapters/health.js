...
export function getPaymentAdaptersHealth() {
  ...
  const cardIntlMode = cardIntl.ready ? 'LIVE_MODE' : 'MOCK_MODE'
  const mirRuMode = mirRu.ready ? 'LIVE_MODE' : 'MOCK_MODE'
  const overallMode = cardIntl.ready && mirRu.ready ? 'LIVE_MODE' : 'MOCK_MODE'
