...
/** Stage 131.A2.1 — Sunday weekly digest for L2/L3 network activity. */
export async function runReferralTeamWeeklyDigest() {
  const { runReferralTeamWeekDigest } = await import(
    '@/lib/services/marketing/referral-team-week-digest.service.js'
  )
  return runReferralTeamWeekDigest()
}
