...
const COPY = {
  ru: {
    ...
    emailFb_partnerCheckInFunds:
      'Средства по-прежнему надёжно удерживаются в эскроу. Уведомим отдельно, когда начнётся разморозка и выплата.',
    ...
    emailFb_listingApprovedSubj: '✅ Объявление одобрено: {title}',
    emailFb_listingApprovedLead:
      'Поздравляем! «{title}» прошло модерацию и опубликовано на {brand}. Гости уже могут бронировать.',
    emailFb_listingRejectedSubj: '❌ Объявление отклонено: {title}',
    emailFb_listingRejectedLead: 'К сожалению, «{title}» не прошло модерацию на {brand}.',
    emailFb_listingRejectedReason: 'Причина: {reason}',
    emailFb_listingRejectedReasonFallback: 'Не указана',
    emailFb_listingRejectedHint: 'Исправьте замечания в кабинете и снова отправьте объявление на модерацию.',
  ...
  en: {
    ...
    emailFb_partnerCheckInFunds:
      'Funds remain safely held in escrow. We will notify you separately when thaw and payout begin.',
    ...
    emailFb_listingApprovedSubj: '✅ Listing approved: {title}',
    emailFb_listingApprovedLead:
      'Great news — “{title}” passed moderation and is published on {brand}. Guests can book it now.',
    emailFb_listingRejectedSubj: '❌ Listing rejected: {title}',
    emailFb_listingRejectedLead: 'Unfortunately, “{title}” did not pass moderation on {brand}.',
    emailFb_listingRejectedReason: 'Reason: {reason}',
    emailFb_listingRejectedReasonFallback: 'Not specified',
    emailFb_listingRejectedHint: 'Update the listing in your dashboard and submit it for moderation again.',
  ...
  zh: {
    ...
    emailFb_partnerCheckInFunds: '资金仍安全托管在托管账户中。解冻与付款开始时我们会另行通知。',
    ...
    emailFb_listingApprovedSubj: '✅ 上架已通过：{title}',
    emailFb_listingApprovedLead: '恭喜！「{title}」已通过审核并在 {brand} 发布，客人现在可以预订。',
    emailFb_listingRejectedSubj: '❌ 上架未通过：{title}',
    emailFb_listingRejectedLead: '很抱歉，「{title}」未通过 {brand} 审核。',
    emailFb_listingRejectedReason: '原因：{reason}',
    emailFb_listingRejectedReasonFallback: '未说明',
    emailFb_listingRejectedHint: '请在合作伙伴中心修改后再次提交审核。',
  ...
  th: {
    ...
    emailFb_partnerCheckInFunds:
      'เงินยังถูกถือในเอสโครวอย่างปลอดภัย เราจะแจ้งแยกเมื่อเริ่มปลดล็อกและจ่ายเงิน',
    ...
    emailFb_listingApprovedSubj: '✅ อนุมัติรายการแล้ว: {title}',
    emailFb_listingApprovedLead:
      'ยินดีด้วย! «{title}» ผ่านการตรวจสอบและเผยแพร่บน {brand} แล้ว ลูกค้าจองได้ทันที',
    emailFb_listingRejectedSubj: '❌ รายการไม่ผ่าน: {title}',
    emailFb_listingRejectedLead: 'ขออภัย «{title}» ไม่ผ่านการตรวจสอบบน {brand}',
    emailFb_listingRejectedReason: 'เหตุผล: {reason}',
    emailFb_listingRejectedReasonFallback: 'ไม่ระบุ',
    emailFb_listingRejectedHint: 'แก้ไขในแดชบอร์ดแล้วส่งตรวจอีกครั้ง',
