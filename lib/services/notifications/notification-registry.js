...
export const NOTIFICATION_REGISTRY = {
  ...
  REFERRAL_FRIEND_BOOKED: { handler: ReferralEvents.handleReferralFriendBooked, isAsync: true },
  REFERRAL_FRIEND_COMPLETED: { handler: ReferralEvents.handleReferralFriendCompleted, isAsync: true },
  REFERRAL_FRIEND_CANCELLED: { handler: ReferralEvents.handleReferralFriendCancelled, isAsync: true },
