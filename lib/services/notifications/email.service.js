 ...
 * Stage 200.74 — escape every line so names/notes/titles cannot break HTML or inject markup.
 */
export function textToHtml(text) {
  ...
  return `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        ...
        <p style="color: #888; font-size: 12px;">${escapeHtml(getSiteDisplayName())} — Ваша платформа для аренды на Пхукете</p>
      </body>
      </html>
    `
}
