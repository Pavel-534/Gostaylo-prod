...
export class PricingService {
   ...
   * @returns {Promise<Map<string, { guestServiceFeePercent: number, hostCommissionPercent: number, insuranceFundPercent: number }>>}
   */
  ...
  static calculateFeeSplitWithPolicy(subtotalThb, policy) {
    ...
    const p = policy || {
      guestServiceFeePercent: DEFAULT_GUEST_SERVICE_FEE_PERCENT,
      hostCommissionPercent: DEFAULT_HOST_COMMISSION_PERCENT,
      insuranceFundPercent: DEFAULT_INSURANCE_FUND_PERCENT,
    };
