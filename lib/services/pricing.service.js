...
export class PricingService {
   ...
   */
  static calculatePrice({ basePriceThb, seasonalPricing, checkIn, checkOut, currency = 'THB', exchangeRates = {} }) {
    // Calculate in THB first
    const calc = this.calculateBookingPriceSync(basePriceThb, checkIn, checkOut, seasonalPricing || [])
