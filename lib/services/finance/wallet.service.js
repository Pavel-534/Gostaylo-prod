...
export class WalletService {
  static async getOrCreateWallet(userId) {
    ...
    const { data: existing, error: readError } = await supabaseAdmin
      .from('user_wallets')
      .select(
        'id,user_id,balance_thb,currency,internal_credits_thb,withdrawable_balance_thb,welcome_bonus_remaining_thb,welcome_bonus_expires_at,verified_for_payout,referral_deficit_thb,updated_at,created_at',
      )
      .eq('user_id', uid)
      .maybeSingle();
