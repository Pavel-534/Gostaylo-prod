...
export function normalizeFintechSettingsRow(row) {
  ...
  return {
    ...
    insuranceFundPercent: parsePercent(row?.insurance_fund_percent, d.insurance_fund_percent),
    ...
    ambassadorGuestPoolL3Percent: parsePercent(
      row?.ambassador_guest_pool_l3_percent,
      d.ambassador_guest_pool_l3_percent,
    ),
    ...
    ambassadorGuestL3Enabled: parseBool(
      row?.ambassador_guest_l3_enabled,
      d.ambassador_guest_l3_enabled,
    ),
    ambassadorGuestL3MinDirectPartners: Math.max(
      0,
      Math.floor(
        Number(row?.ambassador_guest_l3_min_direct_partners ?? d.ambassador_guest_l3_min_direct_partners) || 0,
      ),
    ),
    ambassadorGuestL3MaxThbPerBooking: round2(
      clamp(
        Number(
          row?.ambassador_guest_l3_max_thb_per_booking ?? d.ambassador_guest_l3_max_thb_per_booking,
        ),
        0,
        1_000_000_000,
      ),
    ),
    ambassadorGuestL3MaxThbPerMonth: round2(
      clamp(
        Number(row?.ambassador_guest_l3_max_thb_per_month ?? d.ambassador_guest_l3_max_thb_per_month),
        0,
        1_000_000_000,
      ),
    ),
