...
const FIELD_LABELS = Object.freeze({
  ...
  insurance_fund_percent: 'Страховой резерв %',
  ...
  ambassador_guest_pool_l3_percent: 'Guest pool L3 %',
  ...
  ambassador_guest_l3_enabled: 'Guest L3 включён',
  ambassador_guest_l3_min_direct_partners: 'L3 min direct partners',
  ambassador_guest_l3_max_thb_per_booking: 'L3 cap / бронь THB',
  ambassador_guest_l3_max_thb_per_month: 'L3 cap / месяц THB',
