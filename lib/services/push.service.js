...
const NOTIFICATION_TEMPLATES = {
  ...
  /** Instant book: партнёр сразу получает подтверждённую бронь (Stage 47.0). */
  BOOKING_INSTANT_PARTNER: {
    title: '✅ Новое подтверждённое бронирование',
    titleEn: '✅ New confirmed booking',
    body: '{listing} · {dates} — бронь подтверждена (instant)',
    bodyEn: '{listing} · {dates} — booking confirmed (instant)',
    icon: '/icons/icon-192x192.png',
    tag: 'booking',
    requireInteraction: true
  },
  /** Эскроу разморожен: net к выплате (read-model), ссылка на финансы (Stage 47.0). */
  FUNDS_THAWED_PARTNER: {
    title: '💸 Средства доступны к выводу',
    titleEn: '💸 Funds available for withdrawal',
    body: 'Баланс пополнен на ฿{amount} (net по брони). Откройте «Финансы».',
    bodyEn: 'Your balance was credited ฿{amount} (net for this booking). Open Finances.',
    icon: '/icons/icon-192x192.png',
    tag: 'payout',
    requireInteraction: true
  },
  ...
  PARTNER_GUEST_REVIEW: {
    title: '⭐ Оцените арендатора',
    titleEn: '⭐ Rate your renter',
    body: 'Средства по «{listing}» доступны. Отзыв об арендаторе: {guest}.',
    bodyEn: 'Funds for "{listing}" are available. Review renter {guest}.',
    icon: '/icons/icon-192x192.png',
    tag: 'guest_review',
    requireInteraction: false,
  },
