...
/** @typedef {'listing_photo' | 'dispute_media' | 'chat_image' | 'kyc_document' | 'avatar'} MediaProfileId */

export const MEDIA_PROFILE_IDS = ['listing_photo', 'dispute_media', 'chat_image', 'kyc_document', 'avatar']
