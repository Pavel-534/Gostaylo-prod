...
const ACC_DISPUTE_HOLD = 'la-sys-dispute-hold' // LEDGER_ACC.disputeHold — Stage 203.01 seed
...
export async function postDisputePartnerFundsHold(args) {
  ...
  if (eErr) {
    await skipCompensatingJournalDelete(journalId, 'entries_insert_failed')
