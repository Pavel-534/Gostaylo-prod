...
export const NOTIFICATION_TEMPLATES = {
  ...
  REFERRAL_BONUS_EARNED: {
    ...
    titleTh: '🎁 โบนัสแนะนำ',
    body: '+{amountLabel}. {levelLine} {sourceLine} · Кошелёк · {siteName}',
    bodyEn: '+{amountLabel}. {levelLine} {sourceLine} · Wallet · {siteName}',
    bodyTh: '+{amountLabel}. {levelLine} {sourceLine} · Wallet · {siteName}',
    icon: '/icons/icon-192x192.png',
    tag: 'referral_bonus',
    requireInteraction: true,
  },
