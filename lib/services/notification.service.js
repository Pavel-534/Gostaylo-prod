...
import { getPublicSiteUrl, buildLocalizedSiteUrl, getSiteDisplayName } from '../site-url.js';
...
function escrowCheckInSecurityMessageRu() {
...
export class NotificationService {
  ...
  /** THAWED: FCM + email о net из read-model → /partner/finances (сразу при разморозке, Stage 47.2). */
