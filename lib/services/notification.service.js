...
export class NotificationService {
  ...
  static async handleNewBookingRequest(data) {
    ...
    // 3. Telegram to Partner (if linked) with inline buttons
    ...
    // 4. Admin Topic: BOOKINGS with commission info
  ...
  static async sendTelegramBookingRequest(chatId, data) {
    ...
    const keyboard = {
      inline_keyboard: [
        ...
        [
          { text: '📱 Открыть в приложении', url: `${BASE_URL}/partner/bookings/${booking.id}` }
        ]
      ]
    };
