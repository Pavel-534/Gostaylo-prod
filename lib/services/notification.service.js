/**
 * FunnyRent 2.1 - Notification Service v2.0
...
const SENDER_EMAIL = process.env.SENDER_EMAIL || 'FunnyRent <noreply@funnyrent.com>';
...
export class NotificationService {
  ...
  static async handleNewBookingRequest(data) {
    const { booking, partner, listing, guest } = data;
