...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
    ...
    <tr>
      <td style="padding: 40px 32px;">
        ...
        <div style="text-align: center; margin: 32px 0;">
          <a href="${BASE_URL}" style="display: inline-block; background-color: ${BRAND_COLOR}; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">${t.cta}</a>
        </div>
  ...
  bookingRequested: (booking, lang = 'en') => {
    ...
    const texts = {
      ru: {
        subject: `Заявка на бронирование #${idShort} отправлена`,
      ...
      en: {
        subject: `Booking Request #${idShort} Submitted`,
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  ...
  newLeadAlert: (booking, lang = 'en') => {
    ...
    const texts = {
      ru: {
        subject: `🔔 Новая заявка на бронирование #${idShort}`,
      ...
      en: {
        subject: `🔔 New Booking Request #${idShort}`,
    ...
    <tr>
      <td style="padding: 32px;">
        ...
        <div style="text-align: center; margin: 24px 0;">
          <a href="/partner/bookings/${booking.id}" style="display: inline-block; background-color: #f59e0b; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">${t.cta}</a>
        </div>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <tr>
      <td style="padding: 32px;">
        ...
        <div style="text-align: center; margin: 24px 0;">
          <a href="/partner/dashboard" style="display: inline-block; background-color: #059669; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">${t.cta}</a>
        </div>
