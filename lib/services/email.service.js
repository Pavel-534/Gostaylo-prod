...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f8fafc;">
  ...
  partnerApproved: (partner, lang = 'en') => {
    const texts = {
      ru: {
        subject: '🎉 Поздравляем! Вы стали партнёром FunnyRent',
        greeting: `Здравствуйте, ${partner.name || 'партнёр'}!`,
        body: 'Ваша заявка на партнёрство одобрена! Теперь вы можете размещать свои объекты на FunnyRent.',
        features: [
        ...
        footer: 'Добро пожаловать в семью FunnyRent!\n\nС уважением,\nКоманда FunnyRent'
      },
      en: {
        subject: '🎉 Congratulations! You are now a FunnyRent Partner',
        greeting: `Hello, ${partner.name || 'partner'}!`,
        body: 'Your partnership application has been approved! You can now list your properties on FunnyRent.',
        features: [
        ...
        footer: 'Welcome to the FunnyRent family!\n\nBest regards,\nThe FunnyRent Team'
      }
    };
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <tr>
      <td style="padding: 32px;">
        ...
        <div style="text-align: center; margin: 24px 0;">
          <a href="https://funnyrent.com/partner/dashboard" style="display: inline-block; background-color: #059669; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">${t.cta}</a>
        </div>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, sans-serif; background-color: #f8fafc;">
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <tr>
      <td style="background-color: #f1f5f9; padding: 20px; text-align: center;">
        <p style="margin: 0; color: #64748b; font-size: 11px;">© 2025 FunnyRent</p>
      </td>
    </tr>
  </table>
</body>
