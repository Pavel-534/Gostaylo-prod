...
export async function distribute(bookingId, options = {}) {
    ...
    const appliedSplitRatio = rewardResolution.splitRatioApplied ?? policy.referralSplitRatio;
    const boost = await applyPromoBoost({
      booking,
      policy,
      baseReferralPoolThb: referralPoolThb,
    });
    const baseReferrerAmountThb = round2(referralPoolThb * appliedSplitRatio);
    ...
    return {
      ...
      data: {
        ...
        rewardRule: {
          ...
          splitRatioApplied: appliedSplitRatio,
