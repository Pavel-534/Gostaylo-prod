...
export const PARTNER_KYC_E2E_RUNBOOK_LINES = [
  '1) Renter: open /renter/profile → «Подать заявку» → fill phone/experience → upload KYC → submit. If already PENDING without doc: use «Документ для проверки» on the status card or PATCH /api/v2/partner/applications.',
