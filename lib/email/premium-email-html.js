...
<tr>
  <td style="padding:28px 32px 20px;text-align:center;border-bottom:1px solid ${colors.divider};">
    <p style="margin:0;font-size:22px;font-weight:700;letter-spacing:-0.02em;color:${colors.primary};font-family:${fontFamilyEmail};">${brand}</p>
  </td>
</tr>`
}
...
<tr>
  <td style="padding:24px 32px 28px;text-align:center;border-top:1px solid ${colors.divider};">
    <p style="margin:0;color:${colors.subtle};font-size:12px;line-height:1.5;">© ${y} ${brand}</p>
  </td>
</tr>`
}
