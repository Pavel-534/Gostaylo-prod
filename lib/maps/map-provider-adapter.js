...
export function createLeafletPricePillDivIcon(L, priceText, options = {}) {
  ...
  // Stage 201.78 — inline base colors beat Samsung force-dark; selected toggled via class in DOM.
  void options
  return L.divIcon({
    className: 'gostaylo-price-pill-icon-root',
    html: `<div class="gostaylo-price-pill-marker-slot"><div class="gostaylo-price-pill" style="background:#ffffff;color:#0f172a;border:1px solid #cbd5e1;-webkit-text-fill-color:#0f172a">${safe}</div></div>`,
