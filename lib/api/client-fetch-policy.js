...
/** Nav badge — dedicated unread endpoint (Stage 171.29). */
export const TTL_CHAT_UNREAD_COUNT_MS = 45_000
...
/** Location suggest — popular (empty q) 60s; typed queries short TTL via key. */
export const TTL_LOCATION_SUGGEST_POPULAR_MS = 60_000
export const TTL_LOCATION_SUGGEST_TYPED_MS = 15_000
...
export const CACHE_KEY = {
  ...
  locationSuggest: 'catalog:location-suggest',
