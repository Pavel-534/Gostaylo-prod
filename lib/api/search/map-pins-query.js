...
import { getGuestDisplayPerNight } from '@/lib/pricing/guest-display-price.js'
...
/**
 * @param {object} row
 * @param {import('@/lib/geo/public-coordinate-viewer-context').PublicCoordinateViewerContext | null} [viewerContext]
 */
export function mapPinRowToPayload(row, viewerContext = null) {
  ...
  const guestThb = getGuestDisplayPerNight({
