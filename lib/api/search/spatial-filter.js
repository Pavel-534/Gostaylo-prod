...
import {
  ...
  sortListingsByDistance as sortListingsByDistancePolicy,
 ...
 * @deprecated Stage 167.1 — use catalogSortUsesDistance(parseCatalogSort(searchParams), geoCenter)
 */
export function parseSpatialSortUsed(searchParams, geoCenter) {
  return catalogSortUsesDistance(parseCatalogSort(searchParams), geoCenter)
}

/**
 * @param {object[]} listings
 * @param {Map<string, number>} distanceKmById
 * @deprecated Stage 167.1 — use sortListingsByDistance from ranking-policy
 */
export function sortListingsByDistance(listings, distanceKmById) {
  return sortListingsByDistancePolicy(listings, distanceKmById)
}
