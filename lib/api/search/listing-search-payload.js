 ...
 * Do not shrink to id/title/price/photos[0] — guest cards need rating, specs, L1 currency, geo, trust.
 */
export const LISTINGS_SELECT_LITE = `
        ...
        owner:profiles!owner_id (id, first_name, last_name, is_verified, verification_status)
      `
