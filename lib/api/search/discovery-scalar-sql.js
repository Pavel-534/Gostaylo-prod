/**
 * Stage 177.2b — apply discovery plan scalar + JSONB predicates to Supabase/PostgREST chains.
 */

import { applyDiscoveryJsonbTextEqCiToQuery } from '@/lib/api/search/discovery-jsonb-text-filter'
