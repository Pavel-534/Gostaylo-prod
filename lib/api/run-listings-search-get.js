...
function getCacheKey(filters) {
  ...
  return `${filters.category || 'all'}_${filters.limit}_${where}_${filters.q || ''}_${filters.minPrice || ''}_${filters.maxPrice || ''}`;
}

export async function runListingsSearchGet(request) {
