...
/**
 * Sign out — server clears HttpOnly `gostaylo_session` + sidecars; then client storage,
 * TanStack Query cache (`clearClientQueryCache` via `clearBrowserPersistedAuthState`), Supabase PKCE cache.
 */
