...
import { catalogPublicGeoFields } from '@/lib/api/search/listing-search-payload'
...
export async function buildPublicListingDetailFromDbRow({
  ...
  const transformed = {
    ...
    ...catalogPublicGeoFields(listing),
    ...
    basePriceAsset: readBasePriceAssetFromListing(listing),
    ...
    ownerVerified: String(listing.owner?.verification_status || '').toUpperCase() === 'VERIFIED',
