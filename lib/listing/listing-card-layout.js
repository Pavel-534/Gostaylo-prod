 ...
 * Stage 201.117 / 201.117b — content-visibility removed from live cards (Samsung scroll jitter).
 */
...
/**
 * @deprecated Stage 201.117b — do not put on live `ListingCard` (mobile scroll thrash).
 * Kept empty so old className merges stay harmless.
 */
export const LISTING_CARD_CONTENT_VISIBILITY_CLASS = ''
...
/** Stage 201.97 — hydrate this many listing cards on the first mobile paint. */
export const MOBILE_CATALOG_ABOVE_FOLD_COUNT = 6
