...
/**
 * Stage 201.117 — skip layout/paint for off-screen catalog/grid cards.
 * `auto` remembers last rendered size (fewer scrollbar jumps than fixed-only).
 * Use on `layout="grid"` only — not solo wizard/sheet previews.
 */
