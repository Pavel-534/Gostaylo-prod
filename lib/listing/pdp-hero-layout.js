...
/** Stage 201.118 — reviews block reserve while chunk / IO mounts (CLS). */
export const PDP_REVIEWS_FALLBACK_CLASS = 'min-h-[280px] sm:min-h-[320px]'

/** Scroll target for «Book» CTA when dates are not selected yet (`data-pdp-booking-dates-anchor`). */
export const PDP_BOOKING_DATES_ANCHOR_ATTR = 'data-pdp-booking-dates-anchor'

/** @deprecated use PDP_BOOKING_DATES_ANCHOR_ATTR — kept for imports */
export const PDP_BOOKING_DATES_ANCHOR_ID = 'pdp-booking-dates'
