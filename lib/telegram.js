...
// Topic IDs - These will be created/detected on first use
// In Telegram supergroups with topics enabled, each topic has a message_thread_id
let TOPICS = {
  BOOKINGS: null,     // For new rental requests
  FINANCE: null,      // For payments and USDT TXIDs  
  NEW_PARTNERS: null  // For realtor registrations
};
