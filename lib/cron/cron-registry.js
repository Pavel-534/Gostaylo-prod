...
export const CRON_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    recommendedExternalSchedule: '0 * * * *',
    notes:
      'AUDIT_03 C3.4 — heal payments CONFIRMED without escrow; Vercel daily fallback; Hobby → cron-job.org hourly (POST + CRON_SECRET)',
  },
  {
  ...
  },
  {
    ...
    notes: 'Daily on Vercel; external if fresher FX needed',
  },
  {
