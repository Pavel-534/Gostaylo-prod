/**
 * Stage 130.4 / 198 — Controlled Live soft limits + MIR ops touch (non-blocking).
 * Does not block checkout; TG alerts only (see controlled-live.js).
 * Pilot: set CONTROLLED_LIVE_MAX_THB_PER_DAY + activate Live Mode in FinTech;
 * first MIR + daily soft limit → Telegram FINANCE.
 */
