...
import {
  isBookingTrustPaidStatus,
  isContactRevealedBookingStatus,
...
export function isBookingPaid(bookingStatus) {
  return isBookingTrustPaidStatus(bookingStatus)
}
...
export function areContactsRevealedForBooking(bookingStatus) {
  return isContactRevealedBookingStatus(bookingStatus)
}
