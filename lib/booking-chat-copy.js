...
export function bookingStatusUpdateCopy(previousStatus, newStatus) {
  ...
  const map = {
    ...
    COMPLETED: {
      ...
      bodyRu: 'Бронирование завершено. Спасибо, что выбрали GoStayLo!',
      titleEn: 'Stay completed',
      bodyEn: 'This booking is completed. Thank you for staying with GoStayLo!',
      accent: 'info',
    },
    REFUNDED: {
...
export function buildBookingStatusChatPayload({
  ...
  if (prev === 'PENDING' && next === 'CONFIRMED') {
