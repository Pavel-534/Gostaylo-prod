...
/**
 * Prefer unique vs the whole featured/top grid; if that would hide the rail,
 * only skip the first N featured cards (above-the-fold Top) so discovery still shows.
 */
export const FOR_YOU_EXCLUDE_FEATURED_HEAD = 4
