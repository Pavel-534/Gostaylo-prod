...
/** Shared rail card width — home/PDP «Для вас» + «Недавно смотрели» (Stage 170.8). */
export const RECOMMENDATION_RAIL_CARD_CLASS = 'w-[160px] sm:w-[180px] shrink-0 snap-start'
