...
/**
 * Compact shell — positioning in `app/globals.css` (`.app-public-search-compact-shell`).
 * Do not replace with Tailwind-only string in `lib/` (Tailwind content scan may omit `lib/**`).
 */
export const PUBLIC_SEARCH_CHROME_COMPACT_SHELL_CLASS = 'app-public-search-compact-shell'
