...
/** Sticky compact shell — solid bg (no backdrop-blur: blurs text on scroll morph). */
export const PUBLIC_SEARCH_CHROME_COMPACT_SHELL_CLASS =
  'fixed left-0 right-0 app-fixed-below-header z-[120] hidden border-b border-slate-200 bg-white shadow-sm md:block'
