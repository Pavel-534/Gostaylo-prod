...
import { computeSkipPriceBecauseCalendar } from '@/lib/search/discovery-stay-params'
import {
...
export const FILTER_REGISTRY = {
  ...
  'stay.guests': {
    ...
    applyPlan(contract, plan) {
      ...
      pushScalarPredicate(plan, { column: 'max_capacity', op: 'gte', value: guests })
...
/** Cascade order: category → geo.bbox → housing facets → amenities */
