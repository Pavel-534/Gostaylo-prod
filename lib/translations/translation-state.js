/**
 * Mutable merged UI dictionary (base bundle without lazy-only slices).
 * Chat strings (`slices/chat-ui.js`) merged here since Stage 170.8 so /messages i18n works before route chunk load.
