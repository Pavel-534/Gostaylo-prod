...
/** @typedef {'storefront'|'marketing'|'pdp'|'checkout'|'orderFlow'|'chat'|'partner'|'profile'|'renterReviews'|'auth'} I18nSlicePreset */
...
export const I18N_SLICE_PRESETS = {
  ...
  /** Help / legal / about — `(marketing)/layout.js` (Stage 201.15) */
  marketing: [applyStorefrontCommonI18nSlice, applyErrorsI18nSlice],
