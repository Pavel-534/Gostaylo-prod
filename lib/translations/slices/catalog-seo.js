...
export const catalogSeoUi = {
  ru: {
    ...
    catalogSeo_place_title_default: 'по всему миру',
    catalogSeo_place_title_where: 'в {where}',
    catalogSeo_place_desc_default: 'по всему миру',
    catalogSeo_place_desc_where: 'в районе {where}',
    catalogSeo_place_title_where_ru: 'в {where}, Россия',
    catalogSeo_place_desc_where_ru: 'в {where}, Россия',
    catalogSeo_place_title_where_th: 'в {where}, Таиланд',
    catalogSeo_place_desc_where_th: 'в {where}, Таиланд',
    catalogSeo_place_title_where_generic: 'в {where}',
    catalogSeo_place_desc_where_generic: 'район и контекст: {where}',
  ...
  en: {
    ...
    catalogSeo_place_title_default: 'worldwide',
    catalogSeo_place_title_where: 'in {where}',
    catalogSeo_place_desc_default: 'worldwide',
    catalogSeo_place_desc_where: 'around {where}',
    catalogSeo_place_title_where_ru: 'in {where}, Russia',
    catalogSeo_place_desc_where_ru: 'in {where}, Russia',
    catalogSeo_place_title_where_th: 'in {where}, Thailand',
    catalogSeo_place_desc_where_th: 'around {where}, Thailand',
    catalogSeo_place_title_where_generic: 'in {where}',
    catalogSeo_place_desc_where_generic: 'around {where}',
  ...
  zh: {
    ...
    catalogSeo_place_title_default: '全球',
    catalogSeo_place_title_where: '{where}',
    catalogSeo_place_desc_default: '全球',
    catalogSeo_place_desc_where: '{where} 一带',
    catalogSeo_place_title_where_ru: '{where} · 俄罗斯',
    catalogSeo_place_desc_where_ru: '{where} · 俄罗斯',
    catalogSeo_place_title_where_th: '{where} · 泰国',
    catalogSeo_place_desc_where_th: '{where} · 泰国',
    catalogSeo_place_title_where_generic: '{where}',
    catalogSeo_place_desc_where_generic: '{where} 一带',
  ...
  th: {
    ...
    catalogSeo_place_title_default: 'ทั่วโลก',
    catalogSeo_place_title_where: 'ที่ {where}',
    catalogSeo_place_desc_default: 'ทั่วโลก',
    catalogSeo_place_desc_where: 'บริเวณ {where}',
    catalogSeo_place_title_where_ru: '{where} · รัสเซีย',
    catalogSeo_place_desc_where_ru: '{where} · รัสเซีย',
    catalogSeo_place_title_where_th: '{where} · ไทย',
    catalogSeo_place_desc_where_th: '{where} · ไทย',
    catalogSeo_place_title_where_generic: '{where}',
    catalogSeo_place_desc_where_generic: 'แถบ {where}',
