 ...
 * Stage 144 — фиксирует `ui_locale` снимка UI при создании брони.
 */
 ...
 * @param {{ uiLocale?: string | null | undefined }} [options]
 * @returns {Record<string, unknown>}
 */
export function pickCheckInInstructionsForBookingMetadata(listing, options = {}) {
  const meta =
  ...
  const uiLocale = options?.uiLocale != null ? normalizeUiLocaleCode(options.uiLocale) : null
  if (uiLocale) out.ui_locale = uiLocale
  return out
}
