 ...
 * Stage 201.94 — on-site cleaning/deposit stay in listing THB (no UI FX).
 */
...
/**
 * On-site fees are paid locally in listing THB — never convert with the header FX switcher.
 * @param {number} amountThb
 * @param {string} [language]
 * @returns {string}
 */
export function formatGuestOnSiteFeeAmount(amountThb, language = 'ru') {
  return formatThbAmountAsCode(amountThb, language)
}
