...
/**
 * Статусы, занимающие ночи в календаре (блокируют новые брони).
 * @type {readonly BookingStatusCode[]}
 */
...
/** Partner confirm transport: без PENDING/INQUIRY — только занятые оплаченные интервалы. */
export const TRANSPORT_PARTNER_CONFIRM_OCCUPYING_STATUSES = Object.freeze([
  'CONFIRMED',
  'PAID',
  'PAID_ESCROW',
  'CHECKED_IN',
...
export function transportPartnerConfirmOccupyingCsv() {
  return TRANSPORT_PARTNER_CONFIRM_OCCUPYING_STATUSES.join(',')
}
...
/**
 * @param {BookingStatusCode | string | null | undefined} status
 */
...
/**
 * Статусы с замороженными выплатами / эскроу (для UI и eligibility).
 * @type {readonly BookingStatusCode[]}
 */
export const ESCROW_OR_PAYOUT_PIPELINE_STATUSES = Object.freeze([
  'PAID_ESCROW',
  'CHECKED_IN',
  'THAWED',
  'READY_FOR_PAYOUT',
