...
function buildSnapshot(dispute, booking) {
  ...
  const display = resolveDisputeDisplayFields(booking)
  return {
    id: dispute.id,
    status,
    ...
    /** @deprecated prefer guestDisplayLabel / partnerHoldThb */
    amountThb: display.guestPayableThb,
    guestDisplayAmount: display.guestDisplayAmount,
    guestDisplayCurrency: display.guestDisplayCurrency,
    guestDisplayLabel: display.guestDisplayLabel,
    partnerHoldThb: display.partnerHoldThb,
