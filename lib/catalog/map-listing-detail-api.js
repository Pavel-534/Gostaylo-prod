...
export function mapListingDetailFromApi(l) {
  ...
  return {
    ...
    regionCode: l.regionCode ?? l.region_code ?? null,
    cityCode: l.cityCode ?? l.city_code ?? null,
    country_code: l.countryCode ?? l.country_code ?? null,
    region_code: l.regionCode ?? l.region_code ?? null,
    city_code: l.cityCode ?? l.city_code ?? null,
    latitude: l.latitude,
    ...
    cancellationPolicy:
      ...
      'moderate',
    /** Stage 201.86 — Instant Book must reach PDP CTAs / flow hints (API already returns it). */
    instantBooking: l.instantBooking === true || l.instant_booking === true,
