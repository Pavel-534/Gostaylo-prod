...
/** Soft skips for payout-batch-pools (empty day / wrong calendar day / already batched / manual treasury). */
export const PAYOUT_POOL_SOFT_SKIP_ERRORS = Object.freeze(
  new Set([
    'not_pool_day',
    'no_ready_bookings',
    'all_already_batched',
    // Stage 201.72 — Concierge manual mode: cron still “ran”; must not 503 or cron-job.org disables the job.
    'TREASURY_MANUAL_MODE',
  ]),
)
