...
export function computeWizardStorefrontPricePreview(assetAmount, pricingPolicy, ctx = {}) {
  ...
  const retailRates =
    (ctx.retailExchangeRates && typeof ctx.retailExchangeRates === 'object'
      ? ctx.retailExchangeRates
      : null) ||
    (ctx.exchangeRates && typeof ctx.exchangeRates === 'object' ? ctx.exchangeRates : null)
  ...
  const ratesForListingDisplay = retailRates
    ? { THB: 1, ...retailRates }
    : midRates
      ? { THB: 1, ...midRates }
      : null
