...
/**
 * User-facing / PWA brand (Stage 189.31).
 * Maps white-label placeholder `Platform` → Airento so Home Screen / share sheet
 * never show an empty or internal name. Prod should set NEXT_PUBLIC_SITE_NAME.
 */
export function getPublicBrandDisplayName() {
  const name = getSiteDisplayName()
  return name === 'Platform' ? 'Airento' : name
}
