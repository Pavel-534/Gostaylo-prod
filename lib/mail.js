...
const FROM_EMAIL = process.env.FROM_EMAIL || 'FunnyRent <noreply@funnyrent.com>'
...
export async function sendWelcomeEmail({
  ...
  return sendEmailInternal({
    to,
    subject: '🏝️ Добро пожаловать в FunnyRent!',
    react: WelcomeEmail({
      userName,
      referralCode,
...
export async function sendBookingRequestEmail({
  ...
  return sendEmailInternal({
    ...
    react: BookingRequestEmail({
      ...
      commission,
      partnerEarnings,
      bookingUrl: `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/partner/bookings`,
    }),
  })
}
...
export async function sendPaymentSuccessEmail({
  ...
  return sendEmailInternal({
    ...
    react: PaymentSuccessEmail({
      ...
      partnerPhone,
      address,
      bookingDetailsUrl: `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/renter/bookings`,
    }),
  })
}
