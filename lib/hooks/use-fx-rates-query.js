...
import { fetchExchangeRates, FX_RATES_UPDATED_EVENT, readExchangeRatesCacheSnapshot } from '@/lib/client-data'
import { getQueryClient, getRefetchOnWindowFocusDefault } from '@/lib/query-client'
...
export function useFxRatesQuery(options = {}) {
  ...
  return useQuery({
    ...
    placeholderData: () =>
      readExchangeRatesCacheSnapshot({
        retail,
        allowRetailFallbackForMid: !retail,
      }) ?? THB_ONLY,
  })
}
