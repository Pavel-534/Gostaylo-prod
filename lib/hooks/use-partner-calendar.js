 ...
 */
async function fetchCalendarData({ partnerId, startDate, endDate, listingId }) {
  try {
...
export function usePartnerCalendar(partnerId, options = {}) {
  ...
  const query = useQuery({
    ...
    retry: 2,
    retryDelay: 1000,
    // Stage 200.53.1 — keep previous window while month/overview range loads (no full-page flash).
