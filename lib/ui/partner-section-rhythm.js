...
/**
 * Stage 201.87 — hide page H1 from md+ when AppHeader already shows the workspace title.
 * Keep on mobile (AppHeader center title is `hidden md:…`).
 */
export const PARTNER_HUB_PAGE_TITLE_MD_HIDE_CLASS = 'md:hidden'
