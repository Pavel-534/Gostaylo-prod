                  ...
                  <DialogHeader>
                    <DialogTitle>
                      {authMode === 'login' 
                        ...
                        : (language === 'ru' ? 'Регистрация' : language === 'en' ? 'Sign Up' : language === 'zh' ? '注册' : 'ลงทะเบียน')}
                    </DialogTitle>
                    <DialogDescription>
                      {authMode === 'login'
                        ? (language === 'ru' ? 'Войдите в систему для доступа к платформе' : 'Sign in to access the platform')
                        : (language === 'ru' ? 'Создайте аккаунт для аренды на Пхукете' : 'Create an account for rentals in Phuket')}
                    </DialogDescription>
                  </DialogHeader>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input 
                          ...
                          placeholder={authMode === 'register' ? (language === 'ru' ? 'Минимум 8 символов' : 'At least 8 characters') : '••••••••'}
                          value={loginPassword}
