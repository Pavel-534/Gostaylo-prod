...
import { Database, CheckCircle, XCircle, Users, Home, Calendar, Loader2, ArrowLeft } from 'lucide-react';
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-purple-950/50 border-purple-700/50">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-purple-900/50 rounded-lg p-4">
                    <p className="text-purple-400 text-sm mb-1">Admin User</p>
                    {dbStatus?.adminUser ? (
            ...
            {dbStatus?.tableCounts && (
              <Card className="bg-purple-950/50 border-purple-700/50">
                <CardHeader>
                  <CardTitle className="text-white">Table Counts</CardTitle>
                  <CardDescription className="text-purple-300">
            ...
            {stats?.categories && (
              <Card className="bg-purple-950/50 border-purple-700/50">
                <CardHeader>
                  <CardTitle className="text-white">Categories from Supabase</CardTitle>
                  <CardDescription className="text-purple-300">
