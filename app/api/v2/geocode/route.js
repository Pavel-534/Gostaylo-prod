/**
 * GoStayLo / Airento — Geocoding API via GeoService (Stage 200.35)
 * GET /api/v2/geocode?q=...
 */
...
export async function GET(request) {
  ...
  try {
    ...
    const status = error?.code === 'GEO_QUERY_SHORT' ? 400 : error?.code === 'NOMINATIM_UNAVAILABLE' ? 502 : 500
