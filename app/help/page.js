...
const SECTIONS = [
  {
    ...
    items: [
      ...
      { q: 'Когда списываются деньги?', a: 'Оплата резервируется сразу, но перечисляется партнёру только после успешного заселения.' },
  ...
  },
  {
    ...
    title: 'Escrow-защита',
    items: [
      { q: 'Что такое escrow?', a: 'Это безопасный счёт: ваши средства хранятся у нас и переводятся партнёру только после подтверждения заселения.' },
