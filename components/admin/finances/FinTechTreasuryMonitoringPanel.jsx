...
const TYPE_LABELS = {
  ...
  TREASURY_CRON_STALE: 'Cron stale',
  TREASURY_LEGACY_PAYOUT_BLOCKED: 'Legacy payout',
  TREASURY_CONTROLLED_LIVE_ACTIVATED: 'Controlled Live',
  TREASURY_FIRST_REAL_PAYMENT_DETECTED: 'Первая оплата',
}
