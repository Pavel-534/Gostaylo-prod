    ...
    >
      ...
      */}
      ...
      <div className="relative z-20 mx-auto flex w-full max-w-6xl flex-col items-center px-4 sm:px-6">
        {showTitle ? (
          <h1 className="mb-4 max-w-3xl text-center text-[28px] font-semibold leading-[1.1] tracking-[-0.015em] text-white drop-shadow-md sm:mb-5 sm:text-[40px] lg:text-[44px]">
            {cleanTitle}
          </h1>
        ) : null}

        <p className="mb-6 max-w-2xl text-center text-sm leading-relaxed text-white/90 drop-shadow sm:mb-8 sm:text-[15px]">
          {getUIText('homeHeroPaymentBlurb', language)}
        </p>
