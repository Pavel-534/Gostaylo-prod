...
SSOT по коду: `ARCHITECTURAL_DECISIONS.md`, `docs/TECHNICAL_MANIFESTO.md`, `docs/CONSTITUTION.md` / `docs/SYSTEM_MAP.md` (индекс `docs/ARCHITECTURAL_PASSPORT.md`). Актуальный roadmap: `docs/ROADMAP.md`.  
