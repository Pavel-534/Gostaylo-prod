...
- `EscrowService.moveToEscrow` → `recordCriticalSignal('ESCROW_RPC_FAILED')` on RPC/catch failures; admin health key.
- Test: `__tests__/stage202-17-escrow-alerting.test.js`.
