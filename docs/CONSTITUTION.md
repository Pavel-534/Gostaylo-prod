...
| **DB guardrails (202.15)** | `migrations/stage202_15_db_guardrails.sql` — `profiles_email_lower_idx`; `airento_guard_booking_paid_money_columns` + GUC `airento.allow_paid_price_fix` |
