# Guides — продукт, маркетинг, домены
...
| `PARTNER_WIZARD_DESIGN_HANDOFF.md` | SSOT ритм мастера + hub bookings (через 200.103) |
...
| [`referral/`](./referral/) | Реферальная программа (логика, учёты, гайды) |

Канон архитектуры — не здесь: [`../README.md`](../README.md).
