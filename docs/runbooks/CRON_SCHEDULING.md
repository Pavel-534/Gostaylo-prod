...
| `Airento: reconcile-yookassa-pending` | `/api/cron/reconcile-yookassa-pending` | `*/10 * * * *` | `0 2 * * *` (02:00 UTC) | Stage 202.7 — poll INITIATED MIR via YooKassa GET when webhooks lag |
