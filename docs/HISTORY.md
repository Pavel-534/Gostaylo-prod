...
|-------|------|------------------|--------|
| 202.9 | 2026-08-24 | Host-only 301 gostaylo.com/www → airento.ru (GSC Change of Address) | Done |
...
| 201.52 | 2026-08-16 | Focused field: document focusin + scrollport marker + vv settle retries | Done |
...
| 201.42 | 2026-08-15 | Header logo: white chip baked into SVG badge; drop CSS double-plate layers | Done |
