...
> **Version**: 13.2.93 | **Last Updated**: 2026-08-18 | **201.99** Home widget 10 min cache; **201.98** Home keep-alive + Search tab sheet; **201.97** catalog keep-alive.  
...
| PWA / push | SW + FCM; **201.19** silent push ack; **M1.1** `PushClientInit`; Soft CTA; `unregister` on logout; install UX **200.81**. Catalog phone Search: **201.96** mobile-first mount; **201.97–201.98** shell keep-alive Home↔list, idle chunk+search prefetch, Search tab does not open filter sheet; **201.99** Home rails 10 min stale / no mount-focus refetch | Clients |
