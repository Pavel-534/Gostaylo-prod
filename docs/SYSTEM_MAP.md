...
> **Version**: 13.2.97 | **Last Updated**: 2026-08-18 | **201.103** Home/catalog UI in page HydrationBoundary; **201.101** instant PDP shell; **201.99** Home widget 10 min cache.  
...
| PWA / push | SW + FCM; **201.19** silent push ack; **M1.1** `PushClientInit`; Soft CTA; `unregister` on logout; install UX **200.81**. Catalog phone: **201.96** mobile-first mount (no Leaflet on list); **201.103** Home/catalog UI inside page HydrationBoundary (no shell park); **201.101** instant PDP chrome from cache; Search tab does not open filter sheet; **201.99** Home rails 10 min stale | Clients |
