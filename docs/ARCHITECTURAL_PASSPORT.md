...
> **Version**: 12.179.1.0 | **Last Updated**: 2026-07-12 | **Stage 179.1:** **`CategoryQuickChips`** in mobile sheet (Select replaced). **Stage 179.0:** hero direct pickers; **`.gsl-premium-glass`**. **Stage 178.9:** dynamic destinations + recent search.
