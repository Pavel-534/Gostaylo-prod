...
> **Version**: 7.6.0 | **Last Updated**: 2026-04-24 | **Status**: Production-Ready
> 
...
| `validatePromoCode(code, bookingAmount, { listingOwnerId? })` | Promo validation; `PARTNER` codes scoped to `listingOwnerId` | YES |
