...
> **Version**: 12.179.0.0 | **Last Updated**: 2026-07-12 | **Stage 179.0:** hero direct pickers (`<md`); **`CatalogMobileSearchSheet`** overview-only; **`.gsl-premium-glass`**. **Stage 178.9:** dynamic destinations + recent search history. **Stage 178.8:** mobile tab «Поиск» context.
