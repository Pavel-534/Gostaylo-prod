...
- **Admin marketing IA (Stage 124.0–124.11):** **`/admin/marketing`** — обзор; **`/admin/marketing/roi`** — Referral ROI (Phase D, `referral-roi.report`, `GET /api/admin/marketing/roi`); **`MarketingSubNav`** (+ ROI); FI widget **Referral Economics** → ROI-пульт.
