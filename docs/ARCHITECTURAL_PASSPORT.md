...
| **Партнёрская заявка** | **`POST /api/v2/partner/payouts`** | Заявка в журнал; Concierge — обработка staff вручную. Stub **`/payouts/request`** не создаёт выплату. |
