...
- **Контрольный cron:** новый endpoint **`/api/cron/exchange-rates-refresh`** (защита `CRON_SECRET`) — использовать с шагом 3 часа для гарантированного upsert в `exchange_rates` при истечении TTL.
