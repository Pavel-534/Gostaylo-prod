...
- **SQL:** `database/migrations/047_stage94_auth_profile_trigger_and_core_rls.sql` — триггер **`on_auth_user_created`**, функции **`handle_new_user`**, правка **`current_profile_id()`**, политики на перечисленных таблицах.
