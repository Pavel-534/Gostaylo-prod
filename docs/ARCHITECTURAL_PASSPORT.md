...
|--------|------------|------------|
| **`OCCUPYING_BOOKING_STATUSES`** | Календарь / availability RPC | **INQUIRY** и **AWAITING_PAYMENT** намеренно **вне** списка — мягкий запрос и ссылка на оплату не блокируют ночи до подтверждения/оплаты |
