-- Stage 152.3 — batch_check_listing_availability: per-listing TZ for booking night overlap.
...
COMMENT ON FUNCTION public.batch_check_listing_availability(text[], date, date, integer, text[]) IS
  'Stage 152.3 — batch availability; booking nights via resolve_listing_timezone_v1 (parity with create_booking_atomic_v1).';
