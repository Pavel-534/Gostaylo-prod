-- Stage 77.8 — Fix booking atomic lock for LEFT JOIN categories.
-- Postgres cannot apply FOR UPDATE to nullable side of outer join.
-- Lock only listings row with FOR UPDATE OF l.
