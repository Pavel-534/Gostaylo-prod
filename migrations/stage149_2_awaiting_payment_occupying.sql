-- Stage 149.2 — AWAITING_PAYMENT blocks calendar nights (anti-overbooking during checkout).
-- Stage 149.2b — phantom JOIN fix: booked_load / blocked_load must not count NULL LEFT JOIN rows as 1 unit.
-- SSOT JS: lib/booking/status-sets.js OCCUPYING_BOOKING_STATUSES.
